...
let scroll: &str = NULL;
let stty_args: &str = "stty raw pass8 nl -echo -iexten -cstopb 38400";

/* identification sequence returned in DA and DECID */
let vtiden: &str = "\x33[?6c";
...
/* alt screens */
let allowaltscreen: i32 = 1;

/* allow certain non-interactive (insecure) window operations such as:
 * setting the clipborad text */
let allowwindowops: i32 = 0;
 ...
 */
static MINLATENCY: f64 = 8;
static MAXLATENCY: f64 = 33;
...
static COLORNAME: [&'static str; 256] = [
    /* 8 normal colors */
    "black",
    "red3",
    "green3",
 ...
 */
let defaultfg: u32 = 258;
let defaultbg: u32 = 259;
let defaultcs: u32 = 256;
 ...
 */
static FORCEMOUSEMOD: u64 = ShiftMask;
 ...
 */
static IGNOREMOD: u64 = Mod2Mask|XK_SWITCH_MOD;
